...
""")
    ...
    def test_codeforces_generated_data_has_twenty_one_distinct_cases(self):
        ...
        self.assertTrue({"1B", "460B", "545C", "580C", "893C"}.issubset(
                             {item["id"] for item in generated}))
        self.assertTrue({"1443C", "2033D"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"508A", "1163B2", "1427B", "2075C", "2132B"}.issubset(
                             {item["id"] for item in generated}))
        self.assertTrue({"986B", "1000B", "2196B"}.issubset({item["id"] for item in generated}))
        ...
        self.assertTrue({"1352A"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"1366D"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"20C"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"1729C"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"1833B"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"1843D"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"2171D"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"2171E"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"1868A"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"2196A"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"2218A"}.issubset({item["id"] for item in generated}))
        self.assertTrue({"2218B"}.issubset({item["id"] for item in generated}))
...
"""
    ...
    def test_practice_31180_is_mirrored_with_statistics_data(self):
        ...
        self.assertEqual(rendered.count("在班级数据管理"), 1)
