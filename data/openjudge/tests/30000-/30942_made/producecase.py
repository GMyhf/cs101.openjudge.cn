...
REFERENCE="# External reference: http://cs101.openjudge.cn/practice/30942/statistics/\n# Accepted submission: 52724323\n# Source: http://cs101.openjudge.cn/practice/solution/52724323/\n# License: not declared on the submission page; no license is inferred.\n\ndef main():\n    text = input().strip()\n    k = int(input())\n    seen = {'F' : 0, 'T' : 0}\n    l = {'F' : 0, 'T' : 0}\n    ans = 0\n    for i, ch in enumerate(text):\n        seen[ch] += 1\n        while seen[ch] > k:\n            if text[l[ch]] == ch:\n                seen[ch] -= 1\n            l[ch] = l[ch] + 1\n        min_l = min(l.values())\n        ans = max(ans, i - min_l + 1)\n    print(ans)\n    return\nif __name__ == '__main__':\n    main()\n"
LANGUAGE='Python3'
NUMBER=30942
SAMPLE='TTFF\n2\n'
def _build():
